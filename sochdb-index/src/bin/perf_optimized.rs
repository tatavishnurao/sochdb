...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "🚀 Testing {} vectors of dimension {} with OPTIMIZED parameters",
    ...
    println!(
        "⏱️  Average per vector: {:.2}ms",
        total_elapsed.as_secs_f64() * 1000.0 / num_vectors as f64
    );
